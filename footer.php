            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <ul class="d-flex flex-row float-md-right" id="sitiosRelacionados">
                        <li>
                            <a href="https://www.facebook.com/uid.unitec/">
                                <img src="img/LogoUNITEC.png" class="logoDeSitiosRelacionados" alt="Logo del laboratorio Unitec">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="img/LogoEDETEC.png" class="logoDeSitiosRelacionados" alt="Logo del laboratorio de Edetec">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="img/LogoLATE.png" class="logoDeSitiosRelacionados" alt="Logo del laboratorio de Late">
                            </a>
                        </li>
                    </ul>
                </div>
